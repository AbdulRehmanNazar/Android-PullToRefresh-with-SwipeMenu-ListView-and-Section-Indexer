package com.enode.solutions.swipemu.pulltorefresh.sectionindexer.SectionIndexer;
...
public class SideBladeView extends View
{
	...
	public SideBladeView(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
	}

	public SideBladeView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public SideBladeView(Context context)
	{
		super(context);
	}
...
//		c++;
	...
	private void showPopup(int item)
	{
		if (mPopupWindow == null)
		{
			...
			mPopupWindow = new PopupWindow(mPopupText, 100, 130);
		}
