package com.enode.solutions.swipemu.pulltorefresh.sectionindexer.pulltorefresh;
...
public class PullToRefreshListViewHeader extends LinearLayout
{
	...
	public void setState(int state)
	{
		...
		case STATE_NORMAL:
			...
			mHintTextView.setText("Going to Refresh");
			break;
		case STATE_READY:
			if (mState != STATE_READY)
			{
				...
				mHintTextView.setText("Ready for Refresh");
			}
			break;
