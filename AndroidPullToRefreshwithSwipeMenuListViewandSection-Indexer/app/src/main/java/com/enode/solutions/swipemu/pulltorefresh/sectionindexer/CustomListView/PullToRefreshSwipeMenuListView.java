package com.enode.solutions.swipemu.pulltorefresh.sectionindexer.CustomListView;
...
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.pulltorefresh.PullToRefreshListFooter;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.pulltorefresh.PullToRefreshListViewHeader;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.swipemenulistview.SwipeMenu;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.swipemenulistview.SwipeMenuAdapter;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.swipemenulistview.SwipeMenuCreator;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.swipemenulistview.SwipeMenuLayout;
import com.enode.solutions.swipemu.pulltorefresh.sectionindexer.swipemenulistview.SwipeMenuView;

/**
 * 
 * @author Abdul Rehman Nazar a.rehman.nazar@gmail.com
 */
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener
{
	// Pinned Header View stuff
	...
	private RefreshLoadMoreListViewListener mListViewListener;
	...
	public void configurePinnedHeaderView(int position)
	{
		if (mPinnedHeaderView == null)
		{
			return;
		...
		{
			mAdapter.configurePinnedHeader(mPinnedHeaderView, position, MAX_ALPHA);
		...
		case PinnedHeaderAdapter.PINNED_HEADER_PUSHED_UP:
		{
			...
			mAdapter.configurePinnedHeader(mPinnedHeaderView, position, alpha);
	...
	/**
	 * enable or disable Swipe of listView.
	 *
	 * @param enable
	 */
	...
	public void setRefeshLoadMoreListViewListener(RefreshLoadMoreListViewListener l)
	{
		mListViewListener = l;
	}
